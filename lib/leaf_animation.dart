...
class LeafAnimation extends StatelessWidget {
  ...
  /// Animations for rotation transform during the 'active animations'
  final Animation<double>? rotation;

  /// Animations for translation transform during the 'active animations'
  final Animation<double>? translationX;

  /// Animations for translation transform during the 'active animations'
  final Animation<double>? translationY;

  /// Animations for scale transform during the 'active animations'
