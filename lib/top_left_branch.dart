...
class TopLeftBranch extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
        width: model.utils.scaleDimensions(410),
        height: model.utils.scaleDimensions(280),
          ...
          child: Stack(
            ...
            children: <Widget>[
              Positioned(
                ...
                left: 0,
                child: Container(
                  width: model.utils.scaleDimensions(368),
                  height: model.utils.scaleDimensions(191),
                  child: Image.asset(
              ...
              Positioned(
                top: model.utils.scaleDimensions(110),
                left: model.utils.scaleDimensions(115),
                child: BranchAnimation(
                  animationController: model.idleAnimation,
                  keyframes: <Keyframe<double>>[
                    Keyframe<double>(fraction: 0, value: 0),
                  ...
                  child: Container(
                    width: model.utils.scaleDimensions(155),
                    height: model.utils.scaleDimensions(122),
                    child: Image.asset(
              ...
              Leaf(
                ...
                width: 47,
                height: 98,
                offset: const FractionalOffset(0.05, 0),
              ...
              Leaf(
                ...
                width: 80,
                height: 68,
                offset: const FractionalOffset(0, 0),
              ...
              Leaf(
                ...
                width: 55,
                height: 21,
                offset: const FractionalOffset(0, 0.8),
              ...
              Leaf(
                ...
                width: 76,
                height: 36,
                offset: const FractionalOffset(1, 0.6),
              ...
              Leaf(
                ...
                width: 58,
                height: 60,
                offset: const FractionalOffset(1, 0.9),
